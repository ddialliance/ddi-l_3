This is DDI version 3.3, released for public review on 2018-06-25. Review will 
last for a minimum of 6 weeks.

The current publication includes documentation generated by the COGS 
production platform, additional high level documentation, and examples. 
The high level documentation will be expanded and edited in response to 
review comments. Field level documentation in the standard XHTML format 
will be added to the package. This format does not require review.

For the purpose of the review the COGS documents have not been integrated
in the package. To access the documentation generated by COGS go to:
https://ddialliance.github.io/ddimodel-web/
Click on "Latest Commit Docs"
...
DDI 3.3 XML Schema is released under the terms of the Creative Commons International:
